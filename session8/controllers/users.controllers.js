...
// const { userSearchSchema } = require("../validations/userSearchValidation") // Added into middleware now.
...
const getUsers = (req, res) => {
    // console.log("Controller reached on Auth");

    // Cleaned up session-3 Authorization code from here. Adding into Middleware verifyAuth.js
